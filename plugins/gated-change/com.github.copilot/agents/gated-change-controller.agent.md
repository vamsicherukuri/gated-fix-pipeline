...
- If path 1 fails, refuses, produces something the human doesn't confirm, or behaves inconsistently across attempts, fall back to path 2 rather than retrying path 1 indefinitely.
